...
class terminal:
	...
	def prepareInvoice (self, amtRecieved, billAfterDiscount):
		...
		self.makeInvoice(invoiceId, bill - billAfterDiscount)
	...
	def makeInvoice (self, invoiceId, discount):
		print(discount)
		prods = []
		...
		im.imaker(str(invoiceId), invoiceId, self.operatorId, self.customerId, self.customerName, self.customerContact, prods, discount)
