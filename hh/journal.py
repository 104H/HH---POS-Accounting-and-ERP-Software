...
class journalPanel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_newHoaB = wx.Button( self, wx.ID_ANY, u"New Account", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_newHoaB.Bind(wx.EVT_BUTTON, self.newHoa)
		########### Date Picker End
		...
		bSizerDate.Add (self.m_newHoaB, 1, wx.ALL|wx.EXPAND, 5 )
	...
	def newHoa (self, event):
		dlg = nhoa.GetData(self) 
		dlg.ShowModal()
