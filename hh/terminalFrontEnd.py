...
class terminalPanel ( wx.Panel ):
    ...
    def __init__( self, parent, transactionButtonName, uid ):
        ...
        self.suggestionList.Bind( wx.EVT_LIST_ITEM_SELECTED, self.setInputStreamToSelection)
        self.suggestionList.Bind(wx.EVT_LISTBOX,self.setInputStreamToSelection)
    ...
    def setInputStreamToSelection(self, event):
        print(event)
        print('slect fried')
        print(self.suggestionList.GetSelection())
        listSelection = self.suggestionList.GetString(self.suggestionList.GetSelection())
        self.inputTC.SetValue(listSelection.split()[0])
        self.inputTC.SetFocus()
